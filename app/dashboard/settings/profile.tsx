            ...
            <div className="flex items-center justify-between gap-2 w-full mb-5">
                <div className=" flex items-center gap-2">
                    <Avatar className="h-20 w-20">
                        <AvatarImage alt={CurrentUser.name} src={user.profilePicture} height={180} width={180} />
                ...
                <div className="flex gap-1 items-center justify-center">
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            ...
                            <div className="group flex justify-center items-center relative overflow-hidden w-[150px] h-[150px] rounded-full border border-border bg-slate-100 duration-300 hover:border-primary mx-auto cursor-pointer" >
                                {user?.profilePicture ?
                                    <Image width={150} height={150}
                                        alt={user.name} src={user.profilePicture}
                                    /> : <Image width={150} height={150}
                            ...
                            <div className="flex items-center gap-2 w-full">
                                <div className='relative grow'>
                                    ...
                                    <Input
                                        ...
                                        value={user?.profilePicture} onChange={async (e) => {
